...
BLOG_AUTHOR = "mustaga"  # (translatable)
BLOG_TITLE = "my_first_nikola_site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ma_site.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ma_site.com/"
BLOG_EMAIL = "ma1478@georgetown.edu"
BLOG_DESCRIPTION = "demo_site"  # (translatable)
